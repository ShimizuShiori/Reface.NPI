...
namespace Reface.NPI.Attributes
{
    ...
    {
        /// <summary>
        /// NPI 允许开发者在一个方法上定义多个 <see cref="QueryAttribute"/>，
        /// 以应对可能存在的数据库兼容性问题。
        /// 不同的 <see cref="QueryAttribute"/> 可以通过该属性来区别。
        /// 开发者可以通过修改属性 <see cref="NpiConfig.QuerySelector"/> 来指定使用哪一个 <see cref="QueryAttribute"/>
        /// </summary>
